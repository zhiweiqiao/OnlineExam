...
import com.exam.util.GetQuestionCount;
import com.exam.util.Selector;



public class InquiryExamTestPaperAction extends Action {
  public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {

    AddExaminationPaperForm addExaminationPaperForm = (AddExaminationPaperForm)actionForm;
    ...
    String e_id = null;
    if (httpServletRequest.getParameter("e_id") != null) {
      ...
      examinationPaper = examinationPaperDAO.getByKeyWhenE_stateNull(java.lang.
          Long.parseLong(e_id));
    } else if (httpServletRequest.getAttribute("e_id") != null) {
      e_id = (String) httpServletRequest.getAttribute("e_id");
      examinationPaper.setE_id(java.lang.Long.parseLong(e_id));
      examinationPaperDAO = new ExaminationPaperDAO();
      examinationPaper = examinationPaperDAO.getByKeyWhenE_stateNull(java.lang.
          Long.parseLong(e_id));
    ...
    addExaminationPaperForm.setExaminationPaper(examinationPaper); 
    ...
    return actionMapping.findForward("inquiryexamtestpaper");
